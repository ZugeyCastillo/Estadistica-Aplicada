...
diab <- read.table("Diab.csv", sep = ",", header = T)
diab
...
plot(diab$sexo[diab$censor == 1], scho, ylab = "Schoenfeld",
     main = "Residuales de schoenfeld", xlab = "")